            ...
            <div class="flex flex-col items-start justify-between w-full p-4 lg:flex-row lg:p-8 lg:items-stretch">
              ...
              <div class="flex flex-col items-start justify-end w-full lg:w-2/3 lg:flex-row lg:items-center">
                ...
                <div class="flex items-center lg:ml-6">
                  <button class="flex items-center h-8 px-5 text-sm text-indigo-700 transition duration-150 ease-in-out bg-gray-200 border border-transparent rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 hover:bg-gray-300">
                    Download All
                  </button>
              ...
              <table class="min-w-full bg-white dark:bg-gray-800">
                <thead>
                  <tr class="w-full h-16 py-8 border-b border-gray-300 dark:border-gray-600">
                    ...
                    <th class="pr-6 text-sm font-normal leading-4 tracking-normal text-left text-gray-600 dark:text-gray-400">
                      <div class="relative w-10 text-gray-600 opacity-0 cursor-default dark:text-gray-400">
                        <div class="absolute top-0 right-0 flex items-center justify-center w-5 h-5 mr-2 -mt-1 text-xs text-white bg-indigo-700 rounded-full">3</div>
                        ...
                        <img class="hidden dark:block" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/compact_table_with_actions_and_select-svg8dark.svg" alt="icon-tabler-file">
                      </div>
                    </th>

                    <th role="columnheader" class="pr-6 text-sm font-normal leading-4 tracking-normal text-left text-gray-600 dark:text-gray-400">
                      Project Number
                    </th>
                    ...
                    <td role="columnheader" class="pr-8 text-sm font-normal leading-4 tracking-normal text-left text-gray-600 dark:text-gray-400">
                      More
                    </td>
                  </tr>
                </thead>
                ...
                <tbody>
                  ...
                  @foreach ($projects as $project)
                    ...
                    {{-- <tr class="h-24 border-b border-gray-300 dark:border-gray-600">
                      ...
                      <td class="pr-6 text-sm leading-4 tracking-normal text-gray-800 whitespace-no-wrap dark:text-gray-100">#MC10023</td>

                      <td class="pr-6 text-sm leading-4 tracking-normal text-gray-800 whitespace-no-wrap dark:text-gray-100">Toyota Motors</td>

                      <td class="pr-6 whitespace-no-wrap">
                        <div class="flex items-center">
                          <div class="w-8 h-8">
                            <img src="https://tuk-cdn.s3.amazonaws.com/assets/components/advance_tables/at_2.png" alt="Display Avatar of Carrie Anthony" role="img" class="w-full h-full overflow-hidden rounded-full shadow" />
                          </div>
                          <p class="ml-2 text-sm leading-4 tracking-normal text-gray-800 dark:text-gray-100">Carrie Anthony</p>
                        </div>
                      </td>

                      <td class="pr-6 text-sm leading-4 tracking-normal text-gray-800 whitespace-no-wrap dark:text-gray-100">02.03.20</td>
                      ...
                      <td class="relative pr-8">
                        <button onclick="dropdownFunction(this)" aria-label="dropdown" role="button" class="text-gray-500 border border-transparent rounded cursor-pointer dropbtn focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400" aria-label="Options expandable" role="button">
