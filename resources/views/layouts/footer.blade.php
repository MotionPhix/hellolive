    ...
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      <div class="space-y-8 xl:col-span-1">
        <div class="flex items-center">
          <img class="h-10 w-auto" src="{{ asset('images/logo.png') }}" alt="FirstMark">
          <span class="ml-3 text-xl font-bold text-gray-900 dark:text-white">FirstMark</span>
        </div>
        <p class="text-base text-gray-500 dark:text-gray-400">
          Transform your brand visibility with premium billboard locations across Malawi and Zambia.
        </p>
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            ...
            <ul role="list" class="mt-4 space-y-4">
              <li>
                <a href="#" class="text-base text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">
    ...
    <div class="mt-12 border-t border-gray-200 dark:border-gray-800 pt-8">
      <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        <p class="text-base text-gray-400">
          &copy; {{ date('Y') }} FirstMark Advertising. All rights reserved.
        </p>
        <div class="flex space-x-6">
          <a href="#" class="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
            Privacy Policy
