...
@section('content')
  ...
  <section class="w-full px-6 pb-12 antialiased relative">
    <div class="absolute inset-0 overflow-hidden">
      <video
        class="object-cover w-full h-full"
        autoplay
    ...
    <div class="mx-auto max-w-7xl relative z-10">
      ...
      <!-- Main Hero Content -->
      <div class="container max-w-sm py-32 mx-auto mt-px text-left sm:max-w-md sm:px-4 md:max-w-none md:text-center">
        <h1
          class="font-display text-3xl font-bold leading-10 tracking-tight text-left text-gray-100 md:text-center sm:text-4xl md:text-7xl lg:text-8xl">
          Start crafting your <br class="hidden sm:block"> next great idea
        </h1>

        <div class="mx-auto mt-5 text-gray-200 md:mt-8 md:max-w-lg md:text-center md:text-xl">
      ...
      <div class="max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="grid grid-cols-3 md:grid-cols-5 gap-x-6 sm:gap-x-6">
          <svg class="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 mx-auto text-gray-500 dark:text-neutral-500"
               ...
               enable-background="new 0 0 88 22"><path
      ...
      <div class="relative text-center">
        ...
        <div class="mt-10">
          <a href="{{ route('contact.index') }}"
            ...
            Get Started Today
            <svg class="ml-3 h-5 w-5 transition-transform duration-200 group-hover:translate-x-1" fill="none"
        ...
        <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-3">
          @foreach($testimonials as $testimonial)
            <div class="relative">
              <!-- Testimonial Card -->
              <div
                class="relative p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg transform hover:scale-105 transition-all duration-300">
                <!-- Quote Icon -->
            ...
            <div class="flex justify-end">
              <form
                ...
                <input
                  ...
                  x-model="email"
                  required
                  class="flex-1 w-full px-5 py-3 border border-transparent placeholder-gray-500 focus:ring-2 focus:ring-white focus:border-white sm:max-w-xs rounded-s-full text-white backdrop-blur-sm"
                  placeholder="Enter your email">

                <div class="mt-3 sm:mt-0 sm:flex-shrink-0">
                  <button
                    type="submit"
                    class="w-full bg-white px-5 py-3 border border-transparent text-base font-medium rounded-e-full text-indigo-600 hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600 transform hover:scale-105 transition-all duration-200">
                    Subscribe
                  </button>
                </div>
              </form>
