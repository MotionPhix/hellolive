...
@section('content')
    ...
    <div class="relative h-full flex items-center">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
          <h1 class="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-white tracking-tight">
          ...
          <div class="mt-10 flex flex-col sm:flex-row justify-center gap-4">
            <a href="{{ route('billboards.index') }}"
               class="group inline-flex items-center px-6 py-3 text-base font-medium rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 transition-all duration-200 transform hover:scale-105">
              Explore Billboards
  ...
  <section class="py-20 bg-white dark:bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
        ...
        <div class="group relative p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-500 transition-all duration-300">
          <div class="absolute -top-5 left-6">
            <div class="rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 p-3 transform group-hover:scale-110 transition-transform duration-200">
              <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <h3 class="mt-8 text-xl font-medium text-gray-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
            Strategic Locations
          </h3>
          ...
          <div class="mt-6 flex items-center text-indigo-600 dark:text-indigo-400">
            ...
            <svg class="ml-2 h-4 w-4 transform group-hover:translate-x-2 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  <div class="max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-12">
      <!-- Icon Block -->
      <div>
        <svg class="shrink-0 size-9 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="10" height="14" x="3" y="8" rx="2"/><path d="M5 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2h-2.4"/><path d="M8 18h.01"/></svg>
        <div class="bg-linear-to-r from-gray-200 via-gray-50 to-transparent h-0.5 mt-6 dark:from-neutral-700 dark:via-neutral-900">
      ...
      <!-- Icon Block -->
      <div>
        <svg class="shrink-0 size-9 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 7h-9"/><path d="M14 17H5"/><circle cx="17" cy="17" r="3"/><circle cx="7" cy="7" r="3"/></svg>
        <div class="bg-linear-to-r from-gray-200 via-gray-50 to-transparent h-0.5 mt-6 dark:from-neutral-700 dark:via-neutral-900">
          <div class="bg-gray-400 w-9 h-0.5 dark:bg-neutral-600"></div>
        </div>
        <div class="mt-5">
  ...
  <section class="py-20 bg-gray-50 dark:bg-gray-800/50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-16">
        <h2 class="text-3xl font-extrabold font-display text-gray-900 dark:text-white sm:text-4xl">
  ...
  <section class="relative py-20 overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="relative text-center">
        ...
        <div class="mt-10">
          <a href="{{ route('contact.index') }}"
             class="group inline-flex items-center px-8 py-4 text-lg font-medium rounded-xl bg-white text-indigo-600 hover:bg-opacity-90 transform hover:scale-105 transition-all duration-200">
            Get Started Today
            <svg class="ml-3 h-5 w-5 transition-transform duration-200 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
            </svg>
          </a>
        </div>
  ...
  <section class="py-20 bg-white dark:bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col items-center">
        ...
        <h2 class="mt-4 text-4xl font-display font-bold text-gray-900 dark:text-white text-center">
          See what others are saying
        </h2>

        <div class="h-1 w-24 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full mt-8"></div>

        <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-3">
          @foreach($testimonials as $testimonial)
            <div class="relative">
              <!-- Testimonial Card -->
              <div class="relative p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg transform hover:scale-105 transition-all duration-300">
                <!-- Quote Icon -->
                ...
                <!-- Testimonial Content -->
                <blockquote class="text-lg text-gray-600 dark:text-gray-300">
                  "{{ $testimonial['content'] }}"
                </blockquote>
                ...
                <div class="mt-8 flex items-center gap-4">
                  <div class="flex-shrink-0">
                    <img class="h-12 w-12 rounded-full object-cover ring-4 ring-indigo-50 dark:ring-gray-700"
                         src="{{ $testimonial['avatar'] }}"
                         alt="{{ $testimonial['name'] }}">
                  </div>
                  <div>
                    <div class="font-medium text-gray-900 dark:text-white">{{ $testimonial['name'] }}</div>
                    <div class="text-gray-500 dark:text-gray-400">{{ $testimonial['company'] }}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 items-center">
            ...
            <div>
              <form action="{{ route('newsletter.subscribe') }}"
                    ...
                    class="sm:flex"
                    x-data="{ email: '' }"
                    @submit.prevent="$dispatch('notify', {
                ...
                <input id="email-address"
                       ...
                       x-model="email"
                       required
                       class="w-full px-5 py-3 border border-transparent placeholder-gray-500 focus:ring-2 focus:ring-white focus:border-white sm:max-w-xs rounded-xl bg-white/10 text-white backdrop-blur-sm"
                       placeholder="Enter your email">
                <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                  <button type="submit"
                          class="w-full bg-white px-5 py-3 border border-transparent text-base font-medium rounded-xl text-indigo-600 hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600 transform hover:scale-105 transition-all duration-200">
                    Subscribe
                  </button>
                </div>
              </form>
  ...
  <!-- Add required styles for grid pattern -->
  @push('styles')
    <style>
      .bg-grid-pattern {
  ...
  <!-- Add Alpine.js notification handler -->
  @push('scripts')
    <script>
